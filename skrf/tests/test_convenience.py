...
class ConvenienceTestCase(unittest.TestCase):
    ...
    def test_hfss_touchstone_2_media(self):
        ...
        """
        med = rf.io.hfss_touchstone_2_media(self.hfss_oneport_file)[0]
        med.line(1)
        med_p1,med_p2 = rf.io.hfss_touchstone_2_media(self.hfss_twoport_file)
        med_p1.line(1)
        med_p2.line(1)
    ...
    def test_is_hfss_touchstone(self):
        ...
        self.assertTrue(Touchstone(self.hfss_oneport_file).has_hfss_port_impedances)
        self.assertTrue(Touchstone(self.hfss_twoport_file).has_hfss_port_impedances)
        self.assertTrue(Touchstone(self.hfss_threeport_file).has_hfss_port_impedances)
        self.assertTrue(Touchstone(self.hfss_18dot2).has_hfss_port_impedances)
        self.assertTrue(Touchstone(self.hfss_8ports).has_hfss_port_impedances)
        self.assertTrue(Touchstone(self.hfss_10ports).has_hfss_port_impedances)
        # Touchstone file not from HFSS
        self.assertFalse(Touchstone(os.path.join(self.test_dir, 'ntwk1.s2p')).has_hfss_port_impedances)
