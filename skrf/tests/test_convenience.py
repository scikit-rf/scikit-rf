...
class ConvenienceTestCase(unittest.TestCase):
    ...
    def test_is_hfss_touchstone(self):
        ...
        self.assertTrue(rf.Touchstone(self.hfss_oneport_file).hfss_port_impedances )
        self.assertTrue(rf.Touchstone(self.hfss_twoport_file).hfss_port_impedances )
        self.assertTrue(rf.Touchstone(self.hfss_threeport_file).hfss_port_impedances )
        self.assertTrue(rf.Touchstone(self.hfss_18dot2).hfss_port_impedances)
        self.assertTrue(rf.Touchstone(self.hfss_8ports).hfss_port_impedances)
        self.assertTrue(rf.Touchstone(self.hfss_10ports).hfss_port_impedances)
        # Touchstone file not from HFSS       
        self.assertFalse(rf.Touchstone(os.path.join(self.test_dir, 'ntwk1.s2p')).hfss_port_impedances )
