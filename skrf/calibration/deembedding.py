...
class ImpedanceCancel(Deembedding):
    ...
    class Ieeep370nzc2xthru(Deembedding):
        ...
        def split2xthru(self, s2xthru):
            ...
            temp = skrf.Network(frequency = self.s2xthru.frequency, s = s, z0 = 50)
            ...
            s_fixture_model_r1  = skrf.Network(frequency = s2xthru.frequency, s = fixture_model_1r, z0 = z11x)
            s_fixture_model_r2  = skrf.Network(frequency = s2xthru.frequency, s = fixture_model_2r, z0 = z11x)
