...
from skrf.calibration import OnePort, PHN, SDDL, TRL, SOLT, UnknownThru, \
                             EightTerm, TwoPortOnePath, EnhancedResponse, \
                             TwelveTerm, terminate
...
class SDDLTest(OnePortTest):
    def setUp(self):
        ...
        self.cal = rf.SDDL(is_reciprocal=True,
                           ideals=ideals,
                           measured=measured,
                          )
...
class SDDLWeikle(OnePortTest):
    ...
    def setUp(self):
        ...
        measured = [self.measure(k) for k in actuals]
        self.cal = rf.SDDLWeikle(is_reciprocal=True,
                                 ideals=ideals,
                                 measured=measured,
                                )
...
class PHNTest(OnePortTest):
    ...
    def setUp(self):
        ...
        ideals = [wg.delay_short(45., 'deg', name='ideal ew'),
                  wg.delay_short(90., 'deg', name='ideal qw'),
                  known1,
                  known2,
                 ]
        actuals = [wg.delay_short(20., 'deg', name='true ew'),
        ...
        self.cal = PHN(is_reciprocal=True,
                       ideals=ideals,
                       measured=measured,
                      )
...
class EightTermTest(unittest.TestCase, CalibrationTest):
    ...
    def test_forward_reflection_tracking_accuracy(self):
        ...
        self.assertEqual(self.X.s21*self.X.s12,
    ...
    def test_reverse_reflection_tracking_accuracy(self):
        ...
        self.assertEqual(self.Y.s21 * self.Y.s12,
                         self.cal.coefs_ntwks['reverse reflection tracking'])

    def test_k_accuracy(self):

        self.assertEqual(self.X.s21/self.Y.s12, self.cal.coefs_ntwks['k'])
...
class TREightTermTest(unittest.TestCase, CalibrationTest):
    ...
    def setUp(self):
        ...
        measured = [self.measure(k) for k in ideals]
        cal1 = rf.TwelveTerm(ideals=ideals,
                             measured=measured,
                             n_thrus=1,
                            )
...
class TwelveTermSloppyInitTest(TwelveTermTest):
    ...
    def setUp(self):
        ...
        measured = [self.measure(k) for k in ideals]
        self.cal = TwelveTerm(ideals=NetworkSet(ideals).to_dict(),
...
class SOLTTest(TwelveTermTest):
    ...
    def setUp(self):
        ...
        actuals = [wg.short(nports=2, name='short'),
                   wg.open(nports=2, name='open'),
                   wg.match(nports=2, name='load'),
                   wg.thru(),
                  ]
...
class TwoPortOnePathTest(TwelveTermTest):
    ...
    def setUp(self):
        ...
        measured = [self.measure(k) for k in ideals]
        self.cal = TwoPortOnePath(ideals=ideals,
                                  measured=measured,
                                  source_port=1,
                                  #n_thrus=2,
                                 )
...
class TwoPortOnePathIsEnhancedResponseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cal2 = EnhancedResponse(ideals=ideals,
                                     measured=measured,
                                     source_port=1,
                                    )
...
class UnknownThruTest(EightTermTest):
    ...
    def setUp(self):
        ...
        actuals = [wg.short(nports=2, name='short'),
                   ...
                   wg.impedance_mismatch(50, 45)**\
                        wg.line(20, 'deg', name='line')**\
