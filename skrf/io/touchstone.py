...
class InvalidFrequencyUnit(ValueError):
    """Raised if an invalid frequency unit is detected.
    """
    pass


class TimeseriesFrequencyUnit(InvalidFrequencyUnit):
    """Raised if a time series touchstone file is detected.
    """
    pass


class InvalidParameterValue(ValueError):
    """Raised if a parameter other than ['s', 'y', 'z', 'g', 'h'] is detected.
    """
    pass


class InvalidFormatValue(ValueError):
    """Raised if a format other than ['ma', 'db', 'ri'] is detected.
    """
    pass
...
class TimeseriesTouchstone(Touchstone):
    """
    Class to read time series touchstone files.

    Time series touchstone files are generated by Keysight VNAs [#].
