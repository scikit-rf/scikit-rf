...
from numpy import arccosh, cosh, exp, heaviside, linspace, log, sqrt
...
class Klopfenstein(Taper1D):
    ...
    * rmax: maximum reflection coefficient in the pass band in percentage of :math:`\rho_0`
    ...
    def _phi(self, z: Number, a: Number):
        r"""
        :math:`\phi` function
        """

        return quad(lambda y: iv(1, a * sqrt(1 - y**2)) / a / sqrt(1 - y**2), 0, z)[0]
