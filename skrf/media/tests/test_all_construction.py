...
class CPWTestCase(MediaTestCase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.frequency = rf.Frequency(75, 110, 101, 'ghz')
        self.media = rf.media.CPW(frequency=self.frequency,
                                  w=10e-6,
                                  s=5e-6,
                                  ep_r=11.7,
                                  t=1e-6,
...
class RectangularWaveguideTestCase(MediaTestCase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.frequency = rf.Frequency(75, 110, 101, 'ghz')
        self.media = rf.media.RectangularWaveguide(frequency=self.frequency,
                                                   a=100*mil)
...
class DistributedCircuitTestCase(MediaTestCase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.frequency = rf.Frequency(75, 110, 101, 'ghz')
        self.media = rf.media.DistributedCircuit(frequency=self.frequency,
                                                 I=1,
                                                 C=1,
                                                 R=0,
                                                 G=0)
...
suite.addTests([loader.loadTestsFromTestCase(FreespaceTestCase),
