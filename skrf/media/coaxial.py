...
class Coaxial(DistributedCircuit, Media):
    ...
    def __init__(self, frequency: Frequency | None = None,
        ...
        self.epsilon_prime = const_.epsilon_0*self.epsilon_r
        self.epsilon_second = const_.epsilon_0*self.epsilon_r*self.tan_delta
    ...
    def from_attenuation_VF(cls, frequency: Frequency | None = None,
        ...
        beta = 2 * pi * frequency.f / const_.c / VF
    ...
    def from_Z0_Dout(cls, frequency: Frequency | None = None,
        ...
        **kw :
        ...
        media : :class:`~skrf.media.media.Media`
        """
        ep= const_.epsilon_0*epsilon_r

        if imag(z0) !=0:
            raise NotImplementedError()

        b = Dout/2.
        b_over_a = exp(2*pi*z0*sqrt(ep/const_.mu_0))
        a = b/b_over_a
        Dint = 2*a
    ...
    def L(self) -> NumberLike:
        ...
        """
        return const_.mu_0/(2.*pi)*log(self.b/self.a)
