...
class Parameter(object):
    ...
    def plot(self, m=None, n=None, ax=None, show_legend=True,
             *args, **kwargs):
        ...
        for m in M:
            for n in N:
                ...
                lines.append(plot_complex_rectangular(z=self.val[:, m, n],
    ...
    def plot(self, m=None, n=None, ax=None, show_legend=True,
        ...
        for m in M:
            for n in N:
                ...
                lines.append(plot_rectangular(x=x,
                                              y=self.val[:, m, n],
                                              x_label=x_label,
...
class Network(object):
    ...
    def __str__(self):
        ...
        if len(npy.shape(self.z0)) == 0:
            ...
            z0 = str(self.z0[0, :])
        output = '%i-Port Network: \'%s\',  %s, z0=%s' % (self.nports,
                                                          name,
                                                          str(f),
                                                          z0)
        return output
