...
* Chat: scikit-rf have channels on both [Slack](https://scikit-rf.slack.com) (invitation link is above) and [Matrix](https://app.element.io/#/room/#scikit-rf:matrix.org)  
